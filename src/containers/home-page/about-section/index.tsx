  ...
  return (
    <div className="padding flex flex-col gap-14 lg:gap-0">
      ...
      <div className="flex flex-col items-center lg:items-start md:flex-row md:flex-wrap md:justify-center lg:flex-nowrap lg:justify-between gap-12 md:gap-10 lg:h-[305px] xl:h-[430px] h-[516px]">
        ...
        <div className="flex flex-col items-center gap-2 max-w-[340px] lg:max-w-[231px] xl:max-w-[331px] desktop:max-w-[393px] lg:my-auto">
        ...
        <div className="flex flex-col mx-auto lg:mx-0 items-center gap-2 max-w-[340px] lg:max-w-[224px] xl:max-w-[315px] desktop:max-w-[378px] lg:mt-auto">
