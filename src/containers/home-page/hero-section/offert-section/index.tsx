...
export default function OfferSection() {
  return (
    <div className="flex flex-col md:flex-row items-end gap-4 md:gap-10 lg:gap-12 xl:gap-[70px] desktop:gap-20">
      <div
        className="bg-[#BBF7D0] group w-full overflow-hidden md:w-[31.75%] relative px-7 md:px-4 lg:px-5 xl:px-7 desktop:px-8 py-9 md:py-4 lg:py-5 xl:py-8 desktop:py-9
    ...
    min-h-[254px] md:min-h-[188px] lg:min-h-[216px] xl:min-h-[304px] desktop:min-h-[364px]"
      >
        ...
        <Link
          href="/"
          className="absolute rounded-[50%] z-20 top-4 md:top-3 lg:top-4 xl:top-5 desktop:top-6 right-5 md:right-4 lg:right-5 xl:right-6 desktop:right-8"
        >
          <ArrowButton />
        </Link>
      </div>
      <div
        className="bg-[#F0ABFC] group overflow-hidden w-full md:w-[31.75%] relative flex flex-col px-7 md:px-4 lg:px-5 xl:px-7 desktop:px-8 py-9 md:pt-4 lg:py-5 xl:py-8 desktop:py-9
    rounded-[40px] md:rounded-[35px] lg:rounded-[43px] xl:rounded-[60px] desktop:rounded-[65px]
    min-h-[254px] md:min-h-[229px] lg:min-h-[280px] xl:min-h-[393px] desktop:min-h-[472.65px]"
      >
        ...
        <Link
          href="/"
          className="absolute rounded-[50%] z-20 top-4 md:top-auto md:bottom-3 lg:bottom-4 xl:bottom-5 desktop:bottom-6 right-5 md:right-4 lg:right-5 xl:right-6 desktop:right-8"
        >
          <ArrowButton />
        </Link>
      </div>
      <div
        className="bg-[#D8FDB8] group w-full overflow-hidden md:w-[36.5%] relative flex flex-col px-7 md:px-4 lg:px-5 xl:px-7 desktop:px-8 py-9 md:pt-4 lg:py-5 xl:py-8 desktop:py-9
    rounded-[40px] md:rounded-[35px] lg:rounded-[43px] xl:rounded-[60px] desktop:rounded-[65px]
