...
export default function HeroSection() {
  return (
    <section className="padding flex flex-col pt-[87px] lg:pt-[98px] xl:pt-[130px] desktop:pt-[147px] mb-[200px] gap-[35px] md:gap-[50px] lg:gap-[70px] xl:gap-[90px] 2xl:gap-[110px]">
      <header>
